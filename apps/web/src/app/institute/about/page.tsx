...
export default function AboutUsPage() {
  ...
  const achievements = [
    ...
    },
    {
      icon: Building2,
      title: "R&D Centers",
      desc: "10 VTU Recognized Departments",
    },
        ...
        <div className="container mx-auto px-4 lg:px-6 max-w-5xl">
          <FadeIn>
            <div className="relative text-center mb-12">
              ...
              <Badge
                variant="secondary"
                className="mb-6 px-4 py-1.5 text-sm font-medium rounded-full bg-orange-50 text-orange-700 hover:bg-orange-100 border-none"
              >
                A Crown Jewel of B.V.V.S.
              </Badge>
              <h2 className="text-3xl lg:text-5xl font-bold tracking-tight text-gray-900 leading-tight mb-8">
                Premier Technical Institution in{" "}
                <span className="text-primary">North Karnataka</span>
              </h2>
              ...
              <div className="prose prose-lg text-gray-600 leading-relaxed mx-auto max-w-4xl text-justify space-y-6">
                ...
                <p>
                  BEC is a government-aided institution recognized by{" "}
                  <span className="font-semibold text-gray-900">
                    AICTE, New Delhi
                  </span>{" "}
                  and accredited by{" "}
                ...
                <p>
                  The college has some of the best equipment and facilities in
                  their various departments spread over a vast{" "}
                  <span className="font-semibold text-primary">
                    93-acre campus
                  </span>
          ...
          <FadeIn className="text-center mb-16">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              {credentials.map((cred, i) => (
                <div
                  key={i}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-stone-200 shadow-sm text-sm font-semibold text-gray-700 hover:border-primary/50 hover:text-primary transition-colors cursor-default"
                >
        ...
        <div className="container mx-auto px-4 lg:px-6 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <div className="prose prose-lg text-gray-600 mx-auto max-w-3xl">
              <p>
                Spacious and secure separate hostels for boys and girls,
                campus-wide high speed WiFi, a well-stocked library for both
                print and digital assets, large computer labs with the latest
                equipment and software, multiple canteens and cafeterias
                offering tasty and hygienic food regularly, and electric buggies
                for commuting within the campus make BEC one of the best places
                to teach and learn.
              </p>
            </div>
          </div>
