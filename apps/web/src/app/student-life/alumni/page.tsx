    ...
    return (
        <div className="space-y-16">
            ...
            >
                <div className="lg:col-span-7 space-y-8">
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4 pt-2">
                            <Button className="bg-blue-900 hover:bg-blue-800 text-white px-8 h-12 rounded-xl text-base font-medium shadow-blue-900/20 shadow-lg">
                                Join the Network
                            </Button>
                            <Button variant="outline" className="border-slate-200 text-slate-700 h-12 px-8 rounded-xl hover:bg-slate-100 hover:text-slate-900 font-medium">
                                Alumni Directory
                            </Button>
                        </div>
                    </div>
                        ...
                        {objectives.map((obj, index) => {
                            ...
                            return (
                                <div key={index} className="space-y-3 group">
                                    <div className="w-10 h-10 rounded-lg bg-orange-100/50 flex items-center justify-center text-orange-600 group-hover:scale-110 transition-transform">
                ...
                <div className="lg:col-span-4">
                    <Card className="border-t-4 border-t-orange-500 shadow-xl shadow-slate-200/50 overflow-hidden sticky top-24">
                        ...
                        <CardContent className="flex flex-col items-center text-center p-8 pt-4">
                            <div className="w-24 h-24 rounded-lg bg-slate-50 mb-6 flex items-center justify-center text-slate-300 border border-slate-100">
                                <Users className="w-10 h-10" strokeWidth={1.5} />
                            </div>

                            <h3 className="text-xl font-bold text-blue-600 mb-2">{contactDetails.name}</h3>
                            <p className="text-slate-500 font-medium mb-1">{contactDetails.role}</p>
                            ...
                            <div className="w-full space-y-3">
                                <div className="flex items-center justify-between text-slate-700 bg-slate-50 p-4 rounded-sm">
                                    <span className="font-bold text-[10px] uppercase text-slate-400 tracking-widest text-left">Mobile</span>
                                    <span className="font-bold text-slate-900 text-sm">{contactDetails.mobile}</span>
                                </div>
                                <div className="flex items-center justify-between text-slate-700 bg-slate-50 p-4 rounded-sm">
            ...
            <motion.div
                ...
                className="bg-slate-900 rounded-3xl p-8 lg:p-12 relative overflow-hidden"
            >
                {/* Background Pattern */}
                ...
                <div className="relative z-10 grid lg:grid-cols-3 gap-8 items-center">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <h2 className="text-3xl font-bold text-white">Global Support During Crisis</h2>
                        ...
                        <div className="flex gap-6 pt-4">
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs text-slate-400 uppercase tracking-wider">Active Members</span>
                            </div>
                            <div className="w-px bg-slate-700 h-10 self-center" />
                            <div className="flex flex-col">
                                <span className="text-3xl font-bold text-white">Global</span>
                                <span className="text-xs text-slate-400 uppercase tracking-wider">Reach</span>
                            </div>
                        </div>
                    </div>
                    <div>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {committeeMembers.map((member, index) => (
                        <div key={index} className="group bg-white p-5 rounded-xl border border-slate-100 hover:border-orange-200 hover:shadow-lg hover:shadow-orange-500/5 transition-all duration-300">
                            <div className="flex items-start justify-between mb-3">
                                <div className="w-8 h-8 rounded bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-orange-600 group-hover:text-white transition-colors">
                                    <Users className="w-4 h-4" />
                                </div>
