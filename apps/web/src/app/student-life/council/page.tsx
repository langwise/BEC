            ...
            return (
              ...
              >
                <CardContent className="p-6 text-center">
                  <div
                    className={`w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center ${member.bg} ${member.color}`}
                  >
        ...
        <div className="bg-amber-50 rounded-2xl p-8 border border-amber-100">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {studentRoles.map((role, i) => (
              <div
                key={i}
                className="bg-white p-4 rounded-xl shadow-sm text-center border border-amber-100/50"
              >
