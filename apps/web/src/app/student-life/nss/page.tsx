...
import { Heart, Users, MapPin, Calendar, Award, CheckCircle2, User } from "lucide-react";

const activities = [
    {
        title: "Swachh Bharat",
        description: "Campus and village cleaning drives, sanitation awareness rallies.",
        icon: Users,
    },
    {
        title: "Health Camps",
        description: "Organizing blood donation camps and free health checkups for villagers.",
        icon: Heart,
    },
    {
        title: "Environment",
    ...
    },
    {
        ...
        description: "Volunteering for flood relief, providing food and first aid to victims.",
        icon: Award,
    },
];
            ...
            >
                <div className="space-y-6">
                    <h2 className="text-3xl font-bold text-slate-900 leading-tight">
                        Service to <span className="text-red-600">Humanity</span> is Service to God
                    </h2>
                    <p className="text-lg text-slate-600 leading-relaxed">
                        The NSS unit at Basaveshwar Engineering College has been active since 1995. We aim to instill the idea of social welfare in students, encouraging them to provide service to society without bias. Through volunteerism, students learn the realities of rural life and the dignity of labor.
                    </p>
                    ...
                    <Card className="bg-gradient-to-br from-slate-900 to-slate-800 text-white border-none shadow-xl">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="pt-4 border-t border-slate-700/50 text-sm text-slate-300">
                                ...
                                Volunteers serving 2+ years and 240 hours are entitled to a university certificate signed by the Vice-Chancellor.
                            </div>
                        </CardContent>
                    </Card>
                </div>
            ...
            >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {activities.map((act, index) => (
                        <Card key={index} className="hover:shadow-lg transition-all duration-300 border-t-4 border-t-red-500">
                ...
                <Card className="lg:col-span-1 border-slate-200">
                    ...
                    <CardContent>
                        <div className="text-center p-6 bg-slate-50 rounded-xl mb-4">
                            ...
                            <h3 className="text-lg font-bold text-slate-900">Dr. S. K. Patil</h3>
                            <p className="text-sm text-slate-500 font-semibold">Coordinator, NSS</p>
                            ...
                            <div className="mt-4 pt-4 border-t border-slate-200 space-y-1 text-xs">
                                <p className="font-semibold text-slate-900">Mobile: <span className="text-slate-600 font-normal">9448766350</span></p>
                                <p className="font-semibold text-slate-900">Email: <a href="mailto:skpch@becbgk.edu" className="text-red-600 hover:underline">skpch@becbgk.edu</a></p>
                            </div>
                        </div>
                        <div className="text-sm text-slate-600 text-center hidden">
                            Coordinates all unit activities and reports to the regional NSS coordinator.
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="lg:col-span-2 border-red-50 bg-red-50/30">
                    ...
                    <CardContent>
                        <div className="grid sm:grid-cols-2 gap-4">
                            {milestones.map((m, i) => (
                                <div key={i} className="flex gap-3 bg-white p-4 rounded-lg shadow-sm border border-red-100">
                        ...
                        <p className="mt-6 text-sm text-slate-500">
                            The unit also actively organizes major national festivals including Republic Day, Independence Day, Gandhi Jayanthi, and International Yoga Day.
                        </p>
                    </CardContent>
                </Card>
            </motion.div>
                            ...
                            <a href="#" className="block">
                                <Card className="hover:shadow-lg transition-all duration-300 group-hover:bg-red-50 border-slate-200 group-hover:border-red-200">
                                    <CardContent className="p-4 flex flex-col items-center justify-center text-center">
                                        ...
                                        <span className="font-bold text-slate-900 group-hover:text-red-700">{year}</span>
                                        <span className="text-xs text-slate-500 mt-1 group-hover:text-red-500">View Report</span>
                                    </CardContent>
                                </Card>
                            </a>
                        </div>
