...
import { Play, Pause, Radio, Volume2, Mic2, Music4, Signal } from "lucide-react";
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
                ...
                >
                    <div className="bg-slate-900 rounded-3xl overflow-hidden shadow-2xl relative border border-slate-800">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-orange-600/20 to-blue-900/40 opacity-50" />

                        <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center gap-12">

                            {/* Album Art / Logo Area */}
                            <div className="relative shrink-0">
                                <div className={`w-64 h-64 rounded-full border-8 border-slate-800 shadow-xl bg-gradient-to-tr from-orange-500 to-amber-400 flex items-center justify-center relative ${isPlaying ? 'animate-spin-slow' : ''}`}>
                                    {/* Inner grooves */}
                            ...
                            <div className="flex-1 text-center md:text-left space-y-6">
                                ...
                                <audio ref={audioRef} src="https://stream.zeno.fm/kvm0549y31zuv" crossOrigin="anonymous" />
                                ...
                                <div className="flex flex-col items-center md:items-start gap-6">
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="flex-1 min-w-[200px] h-1 bg-slate-700 rounded-full overflow-hidden">
                                            ...
                                            <div className={`h-full bg-orange-500 rounded-full ${isPlaying ? 'animate-progress-indeterminate' : 'w-0'}`} />
                                        </div>
                ...
                <div className="lg:col-span-12 grid md:grid-cols-3 gap-6">
                    {[
                        { title: "Community Focus", desc: "Empowering the local community with educational content.", icon: Users },
                        { title: "Student RJs", desc: "Run by students, giving voice to young talent.", icon: Mic2 },
                        { title: "Diverse Content", desc: "From agriculture tips to tech trends and classical music.", icon: Radio }
                    ].map((item, i) => (
                        <motion.div
                            key={i}
