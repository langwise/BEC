    ...
    <div className="space-y-16">
      ...
      >
        ...
        <div className="relative z-10 p-8 md:p-12 flex flex-col items-start gap-6">
          ...
          <Button
            size="lg"
            className="bg-white text-violet-600 hover:bg-violet-50 font-bold border-none"
          >
            View Past Gallery
          </Button>
        </div>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start mb-4">
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center ${event.bg} ${event.color}`}
                      >
          ...
          <div className="grid grid-cols-2 gap-4">
            {mindhogClubs.map((club, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/10 text-center hover:bg-white/20 transition-colors"
                >
