...
import { CheckCircle2, FileText, Users, Mail, Phone, Users2 } from "lucide-react";

export default function ObcGrievancePage() {
    const objectives = [
        "To investigate and monitor all matters relating to the safeguards provided for OBC students/staff.",
        "To participate and advise on the planning process of socio-economic development of the OBCs.",
        "To evaluate the progress of the development of Other Backward Classes under the Institute.",
        "To handle grievances regarding admission, scholarships, and discrimination."
    ];

    const committee = [
        { name: "Dr. S. S. Injaganeri", role: "Chairperson", designation: "Principal" },
        { name: "Dr. B. R. Hooli", role: "Member", designation: "Professor" },
        { name: "Ms. S. M. Kulkarni", role: "Member", designation: "Assoc. Professor" },
        { name: "Mr. A. B. Patil", role: "Member", designation: "Admin Officer" },
    ];
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <FadeIn>
                        ...
                        <p className="text-xl text-white/90 max-w-2xl leading-relaxed">
                            Monitoring and safeguarding the interests of Other Backward Classes (OBC) in the institution.
                        </p>
                    </FadeIn>
                </div>
            </section>
                    ...
                    <FadeIn delay={0.4}>
                        <div className="bg-slate-900 rounded-2xl p-6 md:p-8 text-white shadow-xl flex flex-col lg:flex-row items-center justify-between gap-8 max-w-4xl mx-auto">
                            <div className="lg:max-w-2xl">
                                <h2 className="text-2xl font-bold mb-3">Grievance Submission</h2>
                                <p className="text-slate-300 leading-relaxed text-sm md:text-base">
                                    The cell ensures that all OBC students and staff are provided with equal opportunities.
                                    Please report any issues or seek guidance regarding schemes/scholarships through the following channels.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 shrink-0 w-full lg:w-auto bg-white/5 p-4 rounded-xl border border-white/10">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-semibold text-sm">obccell@becbgk.edu</div>
                                    </div>
                                </div>
                            </div>
                        </div>
