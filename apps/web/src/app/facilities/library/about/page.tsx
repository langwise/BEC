                  ...
                  <div className="bg-orange-50 rounded-lg p-8 h-full border border-orange-100">
                    ...
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex gap-2">
                        ...
                        <span>Provide comprehensive access to quality information resources</span>
                      </li>
                      <li className="flex gap-2">
                        <ChevronRight className="h-5 w-5 text-orange-600 flex-shrink-0 mt-0.5" />
                        <span>Support teaching, learning, and research activities</span>
                      </li>
                      <li className="flex gap-2">
                        <ChevronRight className="h-5 w-5 text-orange-600 flex-shrink-0 mt-0.5" />
                        <span>Promote information literacy and digital skills</span>
                      </li>
                      <li className="flex gap-2">
                        <ChevronRight className="h-5 w-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    ...
                    {[
                      {
                        ...
                        description: "Over 1,40,000 books, journals, and reference materials across all engineering disciplines"
                      },
                      {
                        title: "Digital Resources",
                        description: "Access to premium e-journals, e-books, and international databases for research"
                      },
                      {
                        title: "Modern Infrastructure",
                        description: "Spacious reading halls, digital library section, and group study rooms"
                      },
                      {
                        title: "High-Speed Internet",
                        description: "1 Gbps Wi-Fi connectivity throughout the library premises"
                      },
                      {
                        title: "Automated Services",
                        description: "Online catalog (OPAC), digital lending system, and web-based resource discovery"
                      },
                      {
                        title: "Research Support",
                        description: "Dedicated assistance for research scholars and faculty members"
                      },
                      {
                        title: "Extended Hours",
                        description: "Open from 8:00 AM to 8:00 PM on weekdays to support student needs"
                      },
                      {
                        title: "Professional Staff",
                        description: "Experienced librarians and support staff ready to assist users"
                      }
                    ].map((feature, index) => (
