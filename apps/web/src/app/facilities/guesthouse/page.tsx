...
export default function GuestHousePage() {
    const amenities = [
        {
            ...
            description: "Complimentary internet access in all rooms and common areas."
        },
        {
            icon: ThermometerSun,
            title: "Air Conditioned",
            description: "Climate-controlled rooms for a comfortable stay in all seasons."
        },
        {
            icon: Coffee,
            title: "Dining Facility",
            description: "In-house dining serving hygienic and delicious meals for guests."
        },
        {
            icon: Car,
            title: "Ample Parking",
            description: "Secure parking space available within the guest house premises."
        },
        {
            icon: Tv,
            title: "Entertainment",
    ...
    const roomTypes = [
        {
            title: "VIP Suites",
            description: "Premium suites with separate living area, ideal for dignitaries and special guests.",
            features: ["King Size Bed", "Living Room", "Work Desk", "Mini Fridge"],
            image: "/facilities/guesthouse/vip-suite.png"
        },
        {
            title: "AC Deluxe Rooms",
            description: "Well-furnished rooms with modern amenities suitable for faculty and guests.",
    ...
    return (
        <div className="min-h-screen bg-stone-50">
            ...
            <section className="relative h-[400px] overflow-hidden">
                <Image
                    src="/facilities/guesthouse/exterior.png"
                    alt="BEC Guest House Exterior"
                    fill
                    className="object-cover"
                    priority
                />
                <div className="absolute inset-0 bg-gradient-to-r from-slate-900/90 via-slate-900/70 to-transparent"></div>
                <div className="absolute inset-x-0 bottom-0 top-0 bg-gradient-to-t from-slate-900/90 via-transparent to-transparent"></div>
                ...
                <div className="container mx-auto px-4 h-full flex items-center relative z-10">
                    <FadeIn className="max-w-3xl">
                        ...
                        <p className="text-xl md:text-2xl text-white/90 leading-relaxed font-light border-l-4 border-primary pl-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            <FadeIn delay={0.2}>
                                <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6">
                                    Welcome to <span className="text-primary">BEC Guest House</span>
                                </h2>
                                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                                    The Basaveshwar Engineering College Guest House provides specialized accommodation for visiting faculty,
                                    officials, alumni, and parents. Located in a serene corner of the campus, it offers a peaceful
                                    ambiance combined with modern conveniences to ensure a pleasant stay.
                                </p>
                                <p className="text-gray-600 leading-relaxed">
                                    Our facility is equipped with a full-service kitchen, spacious dining area, and well-trained
                                    staff dedicated to making your visit comfortable and memorable.
                                </p>
                            </FadeIn>
                        </div>
                    </div>
                            ...
                            <FadeIn key={index} delay={index * 0.1}>
                                <div className="group bg-white rounded-2xl overflow-hidden shadow-xs hover:shadow-xl transition-all duration-300 border border-stone-200 h-full flex flex-col">
                                    <div className="relative h-48 overflow-hidden">
                                        ...
                                        <h3 className="absolute bottom-4 left-4 text-2xl font-bold text-white">{room.title}</h3>
                                    </div>
            ...
            {/* Booking / Contact */}
            <section className="py-12 bg-gradient-to-br from-slate-900 to-slate-800 text-white relative overflow-hidden">
                            ...
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <p className="text-slate-300 mb-8 text-lg leading-relaxed">
                                        Accommodations are subject to availability. Please contact the Registrar's office for booking enquiries at least 48 hours in advance.
                                    </p>
                                    <div className="space-y-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="font-semibold text-lg">+91-8354-234060</div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center text-primary">
                                            ...
                                            <div>
                                                ...
                                                <div className="font-semibold text-lg">registrar@becbgk.edu</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-white text-slate-900 p-8 rounded-2xl shadow-xl">
                                    ...
                                    <ul className="space-y-4 text-slate-600">
                                        <li className="flex gap-3 items-start">
                                            ...
                                            <span>Check-in time is <span className="font-semibold text-slate-900">12:00 PM</span></span>
                                        </li>
                                        <li className="flex gap-3 items-start">
                                            <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                                            <span>Valid Government ID proof is mandatory for all guests upon arrival</span>
                                        </li>
                                        <li className="flex gap-3 items-start">
                                            <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                                            <span>Prior approval from the Principal or Registrar is required for all bookings</span>
                                        </li>
                                        <li className="flex gap-3 items-start">
                                            <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                                            <span>100% advance payment required for confirmation</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
