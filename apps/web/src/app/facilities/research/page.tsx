  ...
  const researchFacilities = [
    {
      ...
      description:
        "Dedicated centres across various engineering disciplines fostering advanced research and development.",
    ...
    },
    {
      ...
      description:
        "Specialized centres focused on cutting-edge technologies and industry collaborations.",
    ...
    },
    {
      ...
      description:
        "State-of-the-art laboratories equipped with modern instrumentation for experimental research.",
      href: "/research/labs",
    ...
    },
    {
      ...
      title: "IPR & Patents",
      description:
        "Support for intellectual property rights, patent filing, and innovation protection.",
    ...
    },
    {
      ...
      description:
        "Showcasing high-impact research publications by our faculty and scholars.",
    ...
    },
    {
      ...
      description:
        "Comprehensive guidelines, policies, and ethics for conducting research at BEC.",
        ...
        <div className="relative container mx-auto max-w-6xl px-4 lg:px-6 py-14 md:py-18">
          ...
          <div className="mt-4 space-y-4 max-w-3xl">
            ...
            <p className="text-base md:text-lg leading-relaxed text-gray-700">
              Fostering a culture of innovation and discovery through
        ...
        <div className="container mx-auto px-4">
          <FadeIn className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our comprehensive research facilities support interdisciplinary
              studies and advanced technological development
            </p>
          </FadeIn>
                ...
                <FadeIn key={index} delay={index * 0.05}>
                  <Link href={facility.href}>
                    <div className="group h-full bg-white rounded-lg border border-stone-200 hover:border-primary hover:shadow-xl transition-all duration-300 overflow-hidden">
                      <div
                        className={`${facility.bgColor} p-6 flex items-center justify-center transition-transform duration-300 group-hover:scale-105`}
                      >
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="prose text-gray-600 mb-6">
                    <p className="mb-4">
                      Basaveshwar Engineering College has established a robust
                      ecosystem for research and development. Our facilities are
                      designed to encourage collaboration between different
                      engineering disciplines and promote industry-academia
                      interaction.
                    </p>
                    <p>
                      With recognized research centres in 10 disciplines and
                      numerous funded projects, we provide our scholars and
                      faculty with the resources needed to push the boundaries
                      of knowledge.
                    </p>
                  </div>
                  <Link
