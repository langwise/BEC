...
const convocationData = {
    title: "Convocation",
    description: "Celebrating academic excellence and the culmination of our students' journey at Basaveshwar Engineering College.",
    overview: "Graduation Day is a momentous occasion where we honor the hard work, dedication, and achievements of our innovative engineers. It marks not just the end of an academic chapter, but the beginning of a lifelong commitment to excellence.",
    ceremony: {
        title: "13th Graduation Day",
        date: "September 23, 2023",
        description: "The 13th Graduation Day was a grand event celebrating the class of 2023. Distinguished guests, faculty, and proud parents gathered to witness the conferring of degrees and the awarding of gold medals to our top rankers."
    },
    medalists: [
        { name: "Sarvajnya Pujari", dept: "Computer Science & Engg.", rank: "1st Rank", cgpa: "9.82" },
        { name: "Sahana Siddu Rakkasagi", dept: "Civil Engineering", rank: "1st Rank", cgpa: "9.75" },
        { name: "Rashmi Hiremath", dept: "Electronics & Comm. Engg.", rank: "1st Rank", cgpa: "9.68" },
        { name: "Komal Teli", dept: "Electrical & Electronics Engg.", rank: "1st Rank", cgpa: "9.55" },
        { name: "Vinayak R Gotagunki", dept: "Information Science & Engg.", rank: "1st Rank", cgpa: "9.45" },
        { name: "Akash Chougala", dept: "Mechanical Engineering", rank: "1st Rank", cgpa: "9.60" },
        { name: "Arbazali Choudhari", dept: "Automobile Engineering", rank: "1st Rank", cgpa: "9.20" },
        { name: "Kiran V Mallannavar", dept: "Biotechnology", rank: "1st Rank", cgpa: "9.85" },
        { name: "Akshata Konnur", dept: "Electronics & Inst. Engg.", rank: "1st Rank", cgpa: "9.30" },
    ],
    guidelines: [
        {
            question: "Eligibility for Gold Medals",
            answer: "A student shall be eligible for the award of a Gold Medal if they have passed all the courses of the programme in the first attempt and secured the highest CGPA among the eligible candidates."
        },
        {
            question: "Rank Awarding Criteria",
            answer: "Ranks are awarded based on the CGPA secured from the 3rd to the 8th semester. Candidates must complete the course within the stipulated four academic years without any backlog history."
        },
        {
            question: "Dress Code",
            answer: "Graduands are expected to wear formal attire befitting the solemnity of the occasion. The traditional convocation stole will be provided by the college."
        }
    ]
};
...
function MedalistCard({ name, dept, rank, cgpa }: { name: string, dept: string, rank: string, cgpa: string }) {
    return (
            ...
            <CardContent className="p-5 flex items-start gap-4">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 mt-3 text-xs font-semibold uppercase tracking-wider">
                        <span className="bg-yellow-50 text-yellow-700 px-2 py-1 rounded-sm border border-yellow-100">{rank}</span>
                ...
                <section className="max-w-4xl mx-auto space-y-6 text-center">
                    ...
                    <FadeIn delay={0.2}>
                        <div className="mt-8 bg-white border border-stone-200 rounded-2xl p-8 shadow-xs inline-flex flex-col items-center">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 mb-2">{convocationData.ceremony.title}</h3>
                            <p className="text-gray-500 font-medium mb-4">{convocationData.ceremony.date}</p>
                            ...
                            <CardContent className="pt-6">
                                <Accordion type="single" collapsible className="w-full">
                                    {convocationData.guidelines.map((item, idx) => (
                                        <AccordionItem key={idx} value={`item-${idx}`} className="border-stone-100">
                    ...
                    <div>
                        ...
                        <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-6 space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-blue-900 text-lg">Degree Certificates</h4>
                                    <p className="text-blue-800/80 text-sm mt-2 leading-relaxed">
                                        Graduates who could not attend the convocation in person can collect their degree certificates from the Academic Office on working days.
                                    </p>
                                </div>
                            </div>
                            <div className="pt-4 mt-4 border-t border-blue-100">
                                <p className="text-xs text-blue-700 font-medium uppercase tracking-wider mb-2">Contact</p>
                                <p className="text-blue-900 font-semibold">Controller of Examinations</p>
