    ...
    return (
        <Card className="group hover:border-primary/30 hover:shadow-md transition-all duration-300 cursor-pointer bg-white border-stone-200">
            <CardContent className="p-5 flex items-start gap-4">
                <div className="p-3 rounded-lg bg-orange-50 text-primary group-hover:bg-primary group-hover:text-white transition-colors">
            ...
            <div className="container mx-auto px-4 py-12 lg:py-16 relative z-10 space-y-12">
                ...
                <Tabs defaultValue="ug" className="space-y-8">
                    <div className="flex justify-center">
                        <TabsList className="bg-white border border-stone-200 p-1 h-auto rounded-full shadow-sm">
                            <TabsTrigger
                                value="ug"
                                className="rounded-full px-8 py-3 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md transition-all text-base"
                            >
                                Undergraduate (B.E.)
                            </TabsTrigger>
                            <TabsTrigger
                                    ...
                                    <FadeIn key={idx} delay={idx * 0.05}>
                                        <div className="space-y-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-lg bg-orange-100/50 flex items-center justify-center text-orange-600">
                                                    <GraduationCap className="w-4 h-4" />
                                                </div>
                                                <h3 className="font-bold text-gray-900 text-lg">{dept.dept}</h3>
                                            </div>
                                    ...
                                    <FadeIn key={idx} delay={idx * 0.05}>
                                        <div className="space-y-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <h3 className="font-bold text-gray-900 text-lg">{prog.name}</h3>
                                            </div>
                                            <div className="grid gap-3">
