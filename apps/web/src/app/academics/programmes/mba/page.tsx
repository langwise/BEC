...
const mbaData = {
  ...
  description:
    "Transform into a strategic business leader with our comprehensive MBA programme blending management principles with technical expertise.",
  highlights: [
  ...
  // Second-year electives offered, per the Department of Management Studies.
  specializations: [
    "Finance Management",
  ...
  fees: [
    {
      ...
      type: "Un-Aided",
      desc: "Rs. 50,000 (at KEA) + VTU + College Fees",
    },
    {
      quota: "Management Quota",
      type: "Unaided",
      desc: "Mgmt Fees + VTU + College Fees",
    },
  ],
};
      ...
      <section className="space-y-8">
        <div className="prose prose-lg prose-orange max-w-none text-gray-600">
          <p className="text-justify">
            ...
            industry exposure, preparing graduates for leadership roles in
            diverse sectors.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {mbaData.highlights.map((item, idx) => (
            <div
              key={idx}
              className="flex items-center gap-3 p-4 bg-white border border-gray-100 rounded-xl shadow-xs"
            >
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            {mbaData.admission.exams.map((exam, idx) => (
              <div
                key={idx}
                className="px-4 py-2 rounded-full bg-gray-50 border border-gray-200 text-sm font-semibold text-gray-700"
              >
                {exam.name}
              </div>
            ))}
