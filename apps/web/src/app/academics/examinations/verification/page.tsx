        ...
        <div className="space-y-8">
            <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                    Academic document verification for Autonomous-scheme students, for Government departments,
                    verification agencies and academic institutions.
                </p>
            </div>

            <div className="rounded-xl bg-amber-50 border border-amber-200 px-5 py-4 text-sm text-amber-900">
                Verification is available only for students admitted to 1st year (BE / M.Tech / MCA / MBA) from the
                academic year <strong>2007-08</strong> onwards.
            </div>
                ...
                <FadeIn>
                    <div className="bg-white p-6 rounded-2xl border border-stone-200 h-full">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-lg font-bold text-gray-900">Information to Provide</h2>
                        </div>
                ...
                <FadeIn delay={0.1}>
                    <div className="bg-white p-6 rounded-2xl border border-stone-200 h-full">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-lg font-bold text-gray-900">Documents to Attach</h2>
                        </div>
                ...
                <FadeIn>
                    <div className="bg-white p-6 rounded-2xl border border-stone-200 h-full">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-lg font-bold text-gray-900">Fee & Submission</h2>
                        </div>
                        <p className="text-sm text-gray-600 mb-4">
                            <span className="font-semibold text-gray-900">Rs. 500/-</span> per student, payable via NEFT / RTGS.
                        </p>
                        <p className="text-sm text-gray-600 mb-2">Send the completed information and document copies to:</p>
                        <div className="space-y-2">
                            {["becprincipal@yahoo.com", "beccoe2007@gmail.com"].map((email) => (
                                <a
                                    key={email}
                                    href={`mailto:${email}`}
                ...
                <FadeIn delay={0.1}>
                    <div className="bg-white p-6 rounded-2xl border border-stone-200 h-full">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-lg font-bold text-gray-900">Bank Details (NEFT / RTGS)</h2>
                        </div>
                        <dl className="space-y-2.5">
                            {bankDetails.map((row) => (
                                <div key={row.label} className="flex flex-col sm:flex-row sm:justify-between gap-0.5 text-sm">
                                    <dt className="text-gray-500">{row.label}</dt>
                                    <dd className="font-medium text-gray-900 sm:text-right">{row.value}</dd>
                                </div>
                            ))}
                        </dl>
                    </div>
