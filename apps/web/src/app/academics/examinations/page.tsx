                ...
                <FadeIn>
                    <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-xs prose prose-orange max-w-none text-gray-700">
                        <p className="leading-relaxed">
                            Basaveshwar Engineering College, Bagalkote was granted <strong>Autonomous status</strong> from the academic year 2007-2008 by Visvesvaraya Technological University (VTU), Belagavi. The Autonomous Examination Section was established in the year 2007 to oversee the conduct of examinations and evaluation processes.
                        </p>
                        <p className="leading-relaxed mt-4">
                            The examination section is dedicated to maintaining high standards in the assessment of student performance. It is headed by the <strong>Controller of Examinations</strong>, supported by a team of 1 Special Officer, 3 Chief Coordinators, 1 Coordinator and 13 staff members.
                        </p>
                    </div>
                </FadeIn>
            </section>
                ...
                <FadeIn delay={0.1}>
                    <div className="grid md:grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3 p-4 bg-orange-50/50 rounded-xl border border-orange-100">
