...
const getStatusConfig = (status: string) => {
    switch (status) {
        ...
        case "On going":
            return { color: "bg-amber-100 text-amber-800 border-amber-200", icon: TrendingUp };
        default:
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 md:p-12 text-white shadow-2xl">
                ...
                <div className="relative z-10">
                    ...
                    <motion.h1
                        ...
                        className="text-3xl md:text-5xl font-bold mb-6 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-300"
                    >
                        Sponsored Research
                    </motion.h1>
                    <motion.p
                    ...
                    >
                        Pioneering initiatives funded by premier government bodies and industry partners, driving innovation across disciplines.
                    </motion.p>
                </div>
            </div>
                ...
                {years.map((yearGroup, yearIndex) => (
                    ...
                    >
                        <div className="flex items-center gap-4 mb-8">
                            <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-orange-500/20 transform -rotate-3">
                                <Calendar className="w-6 h-6" />
                            </div>
                            <div>
                                <h2 className="text-2xl font-bold text-slate-900">Academic Year {yearGroup.year}</h2>
                                <p className="text-slate-500 font-medium">Research Projects & Grants</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {yearGroup.projects.map((project, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-amber-500 to-orange-600 opacity-0 group-hover:opacity-100 transition-opacity" />
                                        ...
                                        <div className="p-6 md:p-8 flex flex-col h-full">
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-4 justify-between items-start">
                                                ...
                                                <Badge className={cn("pl-2 pr-3 py-1", statusConfig.color)}>
                                            ...
                                            <div className="mt-auto pt-6 border-t border-slate-50 grid grid-cols-2 gap-4">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <div className="font-bold text-2xl text-slate-900 flex items-center justify-end">
                                                        ...
                                                        {project.amount}
                                                        <span className="text-sm font-medium text-slate-500 ml-1">Lakhs</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
