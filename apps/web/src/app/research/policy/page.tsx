        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-12 p-12 items-center">
          ...
          >
            ...
            <p className="text-slate-300 text-lg leading-relaxed">
              Our comprehensive guide to fostering innovation, ensuring ethical
              standards, and supporting the academic growth of our faculty and
              scholars.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button
                asChild
                size="lg"
                className="bg-orange-600 hover:bg-orange-700 text-white shadow-lg shadow-orange-900/20 rounded-xl h-14 px-8 text-base"
              >
                <Link
                  href={policyUrl}
                  download
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="bg-white/10 backdrop-blur-md border-white/20 text-white hover:bg-white/20 hover:text-white hover:border-white/30 rounded-xl h-14 px-8 text-base"
              >
                <Link
                  href={policyUrl}
                  target="_blank"
          ...
          >
            <div className="absolute inset-0 bg-linear-to-br from-orange-500 to-amber-600 rounded-2xl blur-2xl opacity-20 transform rotate-6" />
        ...
        {[
          {
            ...
            icon: Scale,
            desc: "Guidelines for maintaining integrity and transparency in all research methodologies.",
          },
          {
            title: "Funding Support",
            icon: ScrollText,
            desc: "Framework for applying and managing internal and external research grants.",
          },
          {
            title: "Intellectual Property",
            icon: Shield,
            desc: "Policies regarding patents, copyrights, and ownership of innovations.",
          },
        ].map((item, i) => (
          <motion.div
            key={i}
