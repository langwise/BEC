...
const labFeatures = [
  {
    ...
    description:
      "Design and implementation of smart embedded systems using Intel Atom, Galileo, and Edison development boards.",
    icon: Cpu,
    color: "text-blue-600",
    bg: "bg-blue-50",
  ...
  },
  {
    ...
    description:
      "Research into localized data processing and low-latency decision making for Internet of Things (IoT) applications.",
    icon: Server,
  ...
  },
  {
    ...
    description:
      "Optimization of algorithms for multi-core architectures using Intel's parallel processing tools and libraries.",
    icon: Code2,
  ...
  },
  {
    ...
    description:
      "Development of visual recognition systems utilizing high-performance computing resources.",
    icon: Layers,
        ...
        <div className="relative z-10 p-10 md:p-16 text-center">
          ...
          >
            ...
            <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
              Pioneering the next generation of smart devices and
