...
import { Settings, Cpu, Wind, Activity, Zap, CheckCircle2, ChevronRight, Factory } from "lucide-react";
...
const labFeatures = [
    {
        ...
        description: "State-of-the-art hydraulic training systems for understanding fluid power generation, control, and actuation in heavy machinery.",
        icon: Factory,
        color: "text-red-600",
        bg: "bg-red-50",
    ...
    },
    {
        ...
        description: "Advanced pneumatic workstations for designing and simulating automated air-driven control circuits used in manufacturing lines.",
        icon: Wind,
        color: "text-sky-600",
        bg: "bg-sky-50",
    ...
    },
    {
        ...
        description: "Hands-on training with IndroLogic L20 PLCs and diverse industrial sensors (inductive, capacitive, optical) for logic control.",
        icon: Cpu,
        color: "text-blue-600",
        bg: "bg-blue-50",
    ...
    },
    {
        ...
        description: "Integrated mechatronic systems combining mechanics, electronics, and computing for automated handling and assembly.",
        icon: Settings,
                ...
                <div className="relative z-10 p-10 md:p-16 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight leading-tight">
                            Bosch Rexroth Centre for <br className="hidden md:block" /> Industrial Automation
                        </h1>
                        <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
                            A premier collaborative facility bridging the gap between academia and industry through cutting-edge automation technology and practical training.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    >
                        ...
                        <div className="mt-8 pt-6 border-t border-slate-100 relative z-10">
                            <div className="bg-orange-50/80 rounded-xl p-4 border border-orange-100">
                                <div className="text-xs font-semibold text-orange-600 uppercase tracking-wider mb-1">Established In Collaboration With</div>
                                <div className="text-lg font-bold text-slate-900">Bosch Rexroth India Ltd.</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
