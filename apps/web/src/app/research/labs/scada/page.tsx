...
const labFeatures = [
  {
    title: "SCADA Systems",
    description:
      "Real-time monitoring and control of industrial processes using supervisory control and data acquisition architectures.",
    icon: Activity,
    color: "text-blue-600",
    bg: "bg-blue-50",
  ...
  },
  {
    ...
    description:
      "Simulation of smart grid scenarios, fault detection, and automated load management protocols.",
    icon: Zap,
  ...
  },
  {
    ...
    description:
      "Interfacing Programmable Logic Controllers with SCADA software for seamless industrial automation.",
    icon: Server,
  ...
  },
  {
    ...
    description:
      "Acquisition and analysis of operational data to optimize efficiency and predict system maintenance.",
    icon: BarChart3,
        ...
        <div className="relative z-10 p-10 md:p-16 text-center">
          ...
          >
            ...
            <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
              Empowering the future of industrial control through advanced
              Supervisory Control and Data Acquisition research.
            </p>
          </motion.div>
        </div>
      </div>
