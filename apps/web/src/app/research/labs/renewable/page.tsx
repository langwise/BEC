...
const labFeatures = [
  {
    ...
    description:
      "Photovoltaic cell characterization, maximum power point tracking (MPPT) algorithms, and solar thermal applications.",
    icon: Sun,
  ...
  },
  {
    ...
    description:
      "Simulation of wind turbine dynamics, generator control strategies, and grid integration of wind energy.",
    icon: Wind,
    color: "text-sky-600",
    bg: "bg-sky-50",
  ...
  },
  {
    ...
    description:
      "Research into battery management systems (BMS), hybrid storage solutions, and efficiency optimization.",
  ...
  },
  {
    ...
    description:
      "Advanced converters and inverters for efficient power conditioning in renewable energy applications.",
    icon: Zap,
        ...
        <div className="relative z-10 p-10 md:p-16 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight leading-tight">
              Renewable Energy <br className="hidden md:block" /> Research
              Centre
            </h1>
            <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
              Driving the transition to a sustainable future through innovative
              research in green energy technologies.
            </p>
          </motion.div>
        </div>
      </div>
