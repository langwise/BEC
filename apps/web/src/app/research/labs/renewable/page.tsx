...
import { Sun, Wind, BatteryCharging, Zap, Leaf, ChevronRight, CheckCircle2 } from "lucide-react";
import { cn } from "@/lib/utils";

const labFeatures = [
    {
        title: "Solar Energy Systems",
        description: "Photovoltaic cell characterization, maximum power point tracking (MPPT) algorithms, and solar thermal applications.",
        icon: Sun,
    ...
    },
    {
        ...
        description: "Simulation of wind turbine dynamics, generator control strategies, and grid integration of wind energy.",
        icon: Wind,
        color: "text-sky-600",
        bg: "bg-sky-50",
    ...
    },
    {
        ...
        description: "Research into battery management systems (BMS), hybrid storage solutions, and efficiency optimization.",
    ...
    },
    {
        ...
        description: "Advanced converters and inverters for efficient power conditioning in renewable energy applications.",
        icon: Zap,
...
const objectives = [
    "To promote research in sustainable and clean energy technologies.",
    "To evaluate the performance of hybrid renewable energy systems.",
    "To provide a platform for student projects on energy conservation and management.",
    "To collaborate with industry for development of efficient power conversion devices."
];

export default function RenewableEnergyLabPage() {
    return (
                ...
                <div className="relative z-10 p-10 md:p-16 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight leading-tight">
                            Renewable Energy <br className="hidden md:block" /> Research Centre
                        </h1>
                        <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
                            Driving the transition to a sustainable future through innovative research in green energy technologies.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    >
                        ...
                        <div className="mt-8 pt-6 border-t border-slate-100 relative z-10">
                            <div className="bg-green-50/80 rounded-xl p-4 border border-green-100">
                                <div className="text-xs font-semibold text-green-700 uppercase tracking-wider mb-1">Focus Area</div>
                                <div className="text-lg font-bold text-slate-900">Green Tech & Sustainability</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
