...
const labFeatures = [
  {
    ...
    description:
      "Advanced testbeds for experimenting with Next-Generation Mobile Networks, Massive MIMO, and beamforming techniques.",
    icon: Signal,
    color: "text-blue-600",
    bg: "bg-blue-50",
  ...
  },
  {
    ...
    description:
      "Development environments for Narrowband IoT (NB-IoT) and M2M communication protocols utilizing Nokia platforms.",
    icon: Wifi,
    color: "text-sky-600",
    bg: "bg-sky-50",
  ...
  },
  {
    ...
    description:
      "Simulation and testing of high-speed data transmission, network slicing, and quality of service (QoS) optimization.",
    icon: Smartphone,
  ...
  },
  {
    title: "Cloud RAN",
    description:
      "Research into Cloud Radio Access Networks and virtualization of network functions for flexible infrastructure.",
    icon: Cloud,
        ...
        <div className="relative z-10 p-10 md:p-16 text-center">
          ...
          >
            ...
            <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
              Connecting the future through advanced research in mobile
              broadband, 5G networks, and intelligent connectivity protocols.
            </p>
          </motion.div>
        </div>
      </div>
