...
const labFeatures = [
  {
    ...
    description:
      "Industry-standard suites like Intellisuite and COMSOL Multiphysics for finite element analysis and process simulation.",
    icon: Monitor,
  ...
  },
  {
    ...
    description:
      "Design and modeling of capacitive pressure sensors, varied-gap accelerometers, and RF MEMS components.",
    icon: ActivityIcon,
  ...
  },
  {
    ...
    description:
      "Research into thermal and electrostatic actuators for micro-fluidic applications and precision control systems.",
    icon: Layers,
  ...
  },
  {
    ...
    description:
      "Facilities for simulating mechanical, thermal, and electrical properties of micro-machined structures.",
    icon: Microscope,
    color: "text-red-600",
    bg: "bg-red-50",
        ...
        <div className="relative z-10 p-10 md:p-16 text-center">
          ...
          >
            ...
            <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
              Exploring the microscopic world of sensors and intelligent systems
              through advanced simulation and design.
            </p>
          </motion.div>
        </div>
      </div>
