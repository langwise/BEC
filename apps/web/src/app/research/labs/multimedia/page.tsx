...
const labFeatures = [
  {
    ...
    description:
      "High-performance workstations equipped with Maya, Blender, and 3ds Max for 3D modeling and character animation.",
    icon: Box,
  ...
  },
  {
    ...
    description:
      "Professional editing suites for digital video processing, visual effects (VFX), and post-production workflows.",
    icon: Video,
    color: "text-pink-600",
    bg: "bg-pink-50",
  ...
  },
  {
    ...
    description:
      "Development of interactive multimedia applications, UI/UX design prototypes, and web-based media content.",
    icon: MonitorPlay,
  ...
  },
  {
    ...
    description:
      "Facilities for sound design, audio mixing, and synthesis for multimedia projects and game development.",
    icon: Music,
        ...
        <div className="relative z-10 p-10 md:p-16 text-center">
          ...
          >
            ...
            <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
              Unleashing creativity through advanced digital media creation,
              animation, and visual storytelling technologies.
            </p>
          </motion.div>
        </div>
      </div>
