...
import { Droplets, Flame, Gauge, Beaker, ChevronRight, CheckCircle2 } from "lucide-react";
import { cn } from "@/lib/utils";

const labFeatures = [
    {
        title: "Biodiesel Production",
        description: "Small-scale transesterification reactor units for converting vegetable oils and animal fats into biodiesel fuel.",
        icon: Beaker,
    ...
    },
    {
        ...
        description: "Testing facilities for viscosity, flash point, cloud point, and calorific value to ensure ASTM standard compliance.",
        icon: Droplets,
    ...
    },
    {
        ...
        description: "Engine test rigs equipped with gas analyzers to study the combustion characteristics and exhaust emissions of biofuels.",
        icon: Gauge,
        color: "text-red-600",
        bg: "bg-red-50",
    ...
    },
    {
        ...
        description: "Research into flame propagation, injection timing, and fuel atomization in internal combustion engines.",
        icon: Flame,
                ...
                <div className="relative z-10 p-10 md:p-16 text-center">
                    ...
                    >
                        ...
                        <p className="text-orange-50 max-w-3xl text-lg md:text-xl leading-relaxed">
                            Advancing sustainable energy solutions through the development and testing of clean-burning biofuels.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    >
                        ...
                        <div className="mt-8 pt-6 border-t border-slate-100 relative z-10">
                            <div className="bg-green-50/80 rounded-xl p-4 border border-green-100">
                                <div className="text-xs font-semibold text-green-700 uppercase tracking-wider mb-1">Focus</div>
                                <div className="text-lg font-bold text-slate-900">Biofuels & Emissions</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
