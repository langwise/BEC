...
export default function PatentsPage() {
  ...
  const getStatusConfig = (status: string) => {
    if (status.includes("granted") || status.includes("In force"))
      return {
    ...
    <div className="space-y-16">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-8 md:p-12 text-white shadow-2xl">
        ...
        >
          ...
          <p className="text-slate-400 max-w-2xl text-lg leading-relaxed">
            Celebrating the inventive spirit of our research community through
            awarded patents and published discoveries.
          </p>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {patents.map((patent, index) => {
          ...
          const isGranted =
            patent.status.includes("granted") ||
            patent.status.includes("In force");
              ...
              >
                ...
                <div className="p-8 relative z-10 flex flex-col h-full">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                    <Badge
                      variant="secondary"
                      className="bg-slate-50 text-slate-600 border-slate-200 font-medium px-3 py-1.5"
                    >
                      {patent.type} Patent
                    </Badge>
                    <Badge
