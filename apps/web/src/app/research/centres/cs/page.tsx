...
const scholars = [
  {
    ...
    guide: "Dr. S. R. PATIL",
    title:
      "Automatic Detection of Cancerous Cells in Histopathological Images of Uterine Tissue",
  ...
  },
  {
    ...
    title:
      "Data Perception and Resource Management in Cognitive Internet of Things",
  ...
  },
  {
    ...
    guide: "Dr.S P BANGARSHETTI",
    title:
      "Generative AI for Semantic document comparison in Medical Records Enhancing Consistency and Reducing discrepancies",
  ...
  },
  {
    ...
    guide: "Dr. VILAS NAIK",
    title:
      "Analysis of Brain MRI Images in View of Early Detection of Alzheimer using Clinical Data",
    status: "Registered",
    category: "",
  },
  {
    ...
    guide: "Dr. VILAS NAIK",
    title:
      "Precision Agriculture like Crop Yield Prediction Detecting Plant Diseases",
    status: "Registered",
    category: "",
  },
  {
    ...
    guide: "Dr. V B PAGI",
    title:
      "Text Classification by zero shot for learning for Sentiment Analysis",
    status: "Course Work completed",
    category: "",
  },
  {
    ...
    guide: "Dr. V B PAGI",
    title:
      "Human Activity Detection, Recognition and Prediction for Crime Scene Analysis",
    status: "Comprehensive Viva-Voce completed",
    category: "",
  },
  {
    ...
    title:
      "A Novel Methodology to Enhance the User Experience Minimize Delay in Real Time Applications at Edge Computing",
    status: "Course Work completed",
    category: "",
  },
  {
  ...
  },
  {
    ...
    guide: "Dr. ANIL DEVANGAVI",
    title:
      "Machine Learning Based Algorithms to Combat DDoS Wormhole and Botnet Attacks in IoT",
    status: "Registered",
    category: "",
  },
  {
    ...
    guide: "Dr. ANIL DEVANGAVI",
    title:
      "An Energy Efficient Approach for Cluster Based Context Aware Routing in IoT",
    status: "Registered",
    category: "",
  },
  {
...
export default function CSResearchPage() {
  return (
    <div className="space-y-12">
      {/* Header Section */}
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-violet-900 to-indigo-900 p-8 md:p-12 text-white shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            ...
            >
              Driving innovation in Artificial Intelligence, Machine Learning,
          ...
          <table className="w-full min-w-[1400px] text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                <th className="p-3 md:p-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap w-20 hidden md:table-cell">
                  Sl. No
                </th>
