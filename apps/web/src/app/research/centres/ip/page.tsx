...
const stats = [
    { label: "Guides", value: "06", icon: Users, color: "text-red-600", bg: "bg-red-50" },
    { label: "Registered", value: "13", icon: BookOpen, color: "text-slate-600", bg: "bg-slate-50" },
    { label: "Awarded", value: "12", icon: Award, color: "text-amber-600", bg: "bg-amber-50" },
];
...
const scholars = [
    {
        ...
        coGuide: "--",
        title: "Modelling and analyses of green supply chain management (GSCM) issues and practices in process industries.",
    ...
    },
    {
        ...
        coGuide: "--",
        title: "Investigating the status of lean manufacturing practices in SMEs and development of a conceptual implementation model for production performance evaluation.",
        status: "Submitted",
        category: "GM",
    },
    {
        ...
        guide: "Dr. S. T. Dundur",
        coGuide: "--",
        title: "An investigation into the use age of Argo based trash as the alternative fuel for all season co-generation of electricity in sugar industries.",
    ...
    },
    {
        ...
        guide: "Dr. S. T. Dundur",
        coGuide: "--",
        title: "Finite element analysis of machining of work material synthesized from metal matrix composites from micro photographs",
        status: "Course work completed",
        category: "GM",
    },
    {
        ...
        guide: "Dr. C. M. Javalagi",
        coGuide: "--",
        title: "Analysis of key supply chain drivers in medium and small scale industries. (MSME's)",
    ...
    },
    {
        ...
        guide: "Dr. S. T. Dundur",
        coGuide: "--",
        title: "An investigation on the characteristics associated with cryogenic machining of elastomers",
        status: "Open Seminar I and II completed",
        category: "OBC",
    },
    {
        ...
        guide: "Dr. C. M. Javalagi",
        coGuide: "--",
        title: "Lean Supply Chain key performance indicator Analysis in Small and Medium Scale Industries",
        status: "Comprehensive Viva -Voce completed",
        category: "GM",
    },
    {
        ...
        coGuide: "--",
        title: "Aluminium Die Casting Simulation Modeling for Cost benefit Analysis",
        status: "Course work completed",
        category: "OBC",
    },
    {
        ...
        guide: "Dr. V. S. Puranik",
        coGuide: "--",
        title: "A new comprehensive methodology for enabling Environmentally conscious design and assessment of sustainability in an Indian Manufacturing organization",
        status: "Comprehensive Viva -Voce completed",
        category: "ST",
    },
];
...
export default function IPResearchPage() {
    return (
        <div className="space-y-12">
            {/* Header Section */}
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-red-900 to-slate-900 p-8 md:p-12 text-white shadow-xl">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        >
                            Driving efficiency in Manufacturing, Supply Chain, and Strategic Management.
                        </motion.p>
                    </div>
                </div>
            </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 left-6 right-6">
                            ...
                            <h3 className="text-xl font-bold text-white">Dept. of I & P Engineering</h3>
                        </div>
                    </motion.div>
                </div>
            </div>
                    ...
                    <table className="w-full min-w-[1400px] text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50/50 border-b border-slate-100">
                                ...
                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap min-w-[150px]">Co-Guide</th>
                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider min-w-[400px]">Title of Ph.D.</th>
                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Current Status</th>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {scholars.map((scholar, index) => (
                                <tr key={scholar.usn || index} className="hover:bg-slate-50/80 transition-colors">
                                    ...
                                    <td className="p-4 text-sm text-slate-500 whitespace-nowrap text-center">{scholar.coGuide}</td>
                                    ...
                                    <td className="p-4 text-sm text-slate-600 whitespace-nowrap">
                                        <span className={cn("inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium",
                                            scholar.status.toLowerCase().includes("completed") ? "bg-green-100 text-green-800" :
                                                scholar.status.toLowerCase().includes("submitted") ? "bg-blue-100 text-blue-800" :
