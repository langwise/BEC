...
const scholars = [
  ...
  },
  {
    ...
    guide: "Dr. Lokesh B. Bhajantri",
    title:
      "Secure Data Management and Processing in Semantic Web using Cognitive Approach",
  },
];
...
export default function ISResearchPage() {
  return (
    <div className="space-y-12">
      {/* Header Section */}
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-cyan-700 to-blue-800 p-8 md:p-12 text-white shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            ...
            >
              Exploring the frontiers of Cloud Computing, IoT, and Artificial
              Intelligence.
            </motion.p>
          </div>
        </div>
            ...
            <tbody className="divide-y divide-slate-100">
              {scholars.map((scholar, index) => (
                ...
                >
                  ...
                  <td className="p-3 md:p-4 text-sm font-medium text-slate-600 whitespace-nowrap text-center">
