...
const stats = [
    { label: "Guides", value: "12", icon: Users, color: "text-amber-600", bg: "bg-amber-50" },
    { label: "Registered", value: "29", icon: BookOpen, color: "text-orange-600", bg: "bg-orange-50" },
    { label: "Awarded", value: "12", icon: Award, color: "text-yellow-600", bg: "bg-yellow-50" },
];
...
const scholars = [
    ...
    },
    {
        ...
        year: "2016",
        topic: "Effect of monaural and binaural hearing aids on source localization",
    },
    {
        slNo: "6",
        ...
        guide: "Dr. P.N.Kulkarni",
        year: "2017",
        topic: "Spectral Splitting of Speech signal to reduce effect of masking due to sensorinual using time varying filters for binaural dichotic presentation",
    },
    {
        slNo: "7",
        name: "Ujwala.Nandini",
    ...
    },
    {
        ...
        guide: "Dr. B.G.Sheeparamatti",
        year: "June 2022",
        topic: "Fabrication and characterization of novel thin, films for energy applications",
    },
    {
        slNo: "9",
        ...
        topic: "Development of effective speech recognition system and vocabulary building for children with cochlear implants",
    },
    {
        slNo: "10",
    ...
    },
    {
        ...
        year: "2021",
        topic: "IoT Data Aggregation for vertical and Horizontal with Edge Computing",
    },
    {
        slNo: "13",
        ...
        year: "2023",
        topic: "Design and Development of Contactless care system using RADAR Sensors for Differently abled and Geriatric People",
    },
    {
        slNo: "14",
    ...
    },
    {
        ...
        guide: "Dr. Mahabaleshwar S.K.",
        year: "2023",
        topic: "Machine learning based algorithms to mitigate eavesdropping spoofing and privacy leakage attacks in IoT.",
    },
    {
        slNo: "18",
        ...
        year: "2021",
        topic: "Optimizing Resource Utliazation and Enchnancing Performanance of LTE Advance Communication System.",
    },
    {
        slNo: "19",
        ...
        guide: "Dr. Santosh Kumblawati",
        year: "2023",
        topic: "Design and performance evaluation of smart and secured routing protocol for VANET's",
    },
    {
        slNo: "20",
        name: "Sneha Kotin",
    ...
    },
    {
        ...
        year: "2022",
        topic: "Artificial intelegence based resource management techniques for edge computing",
    },
];
...
export default function ECResearchPage() {
    return (
        <div className="space-y-12">
            {/* Header Section */}
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-amber-700 to-orange-800 p-8 md:p-12 text-white shadow-xl">
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 left-6 right-6">
                            ...
                            <h3 className="text-xl font-bold text-white">Dept. of E & C Engineering</h3>
                        </div>
                    </motion.div>
                </div>
            </div>
                    ...
                    <table className="w-full min-w-[1400px] text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50/50 border-b border-slate-100">
                                ...
                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap min-w-[200px]">Name of the Student</th>
                                ...
                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Year of Reg.</th>
                                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-wider min-w-[400px]">Research Topic</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                            {scholars.map((scholar, index) => (
                                <tr key={scholar.usn || index} className="hover:bg-slate-50/80 transition-colors">
                                    ...
                                    <td className="p-4 text-sm text-slate-600 whitespace-nowrap font-medium text-center bg-amber-50/50 rounded-lg mx-2">
                                        {scholar.year}
                                    </td>
                                    <td className="p-4 text-sm text-slate-700 leading-relaxed">{scholar.topic}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
