...
const scholars = [
  {
    ...
    admissionYear: "2017",
    title:
      "An Empirical Investigation on Rural Women Empowerment through Government Sponsored Schemes in Karnataka",
  ...
  },
  {
    ...
    admissionYear: "2022",
    title:
      "Role of Micro Finance Institutions in Financial Inclusion with Special reference to North Karnataka",
    guide: "Dr. Rashmi R. Hunnur",
    coGuide: "-",
  },
  {
    ...
    admissionYear: "2022",
    title:
      "An analysis on Investment Strategy among Investors in Kalyana Karnataka Region",
    guide: "Dr. Rashmi R. Hunnur",
...
export default function MBAResearchPage() {
  return (
    <div className="space-y-12">
      {/* Header Section */}
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-rose-900 to-purple-900 p-8 md:p-12 text-white shadow-xl">
            ...
            <tbody className="divide-y divide-slate-100">
              {scholars.map((scholar, index) => (
                ...
                >
                  ...
                  <td className="p-3 md:p-4 text-sm text-slate-600 whitespace-nowrap text-center">
