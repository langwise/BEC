...
const stats = [
    { label: "Guides", value: "02", icon: Users, color: "text-purple-600", bg: "bg-purple-50" },
    { label: "Registered", value: "02", icon: BookOpen, color: "text-fuchsia-600", bg: "bg-fuchsia-50" },
...
const scholars = [
    {
        ...
        title: "Open seminar 1 completed on 22th May 2025. Comprehensive Viva-Voce completed on 2019.",
        status: "Registered",
...
export default function PhysicsResearchPage() {
    return (
        <div className="space-y-12">
            {/* Header Section */}
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-800 to-fuchsia-900 p-8 md:p-12 text-white shadow-xl">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        >
                            Advanced research in Material Science, Spectroscopy, and Composites.
                        </motion.p>
                    </div>
                </div>
            </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 left-6 right-6">
                            ...
                            <h3 className="text-xl font-bold text-white">Department of Physics</h3>
                        </div>
                    </motion.div>
                </div>
            </div>
