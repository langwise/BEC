          ...
          {publicationYears.map((item, index) => (
            ...
            >
              <div className="relative bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-orange-100/50 transition-all duration-300 p-6 flex flex-col h-full overflow-hidden">
                {/* Gradient Effect */}
                <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-orange-500 to-amber-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
                ...
                <div className="mb-6 flex-grow">
                  ...
                  <p className="text-slate-500 text-sm">Academic Year Report</p>
                </div>
