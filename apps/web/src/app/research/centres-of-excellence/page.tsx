  ...
  const centres = [
    {
      ...
      description:
        "Promoting micro and nano technology in India under NPMASS (GoI). Advanced sensor design and fabrication.",
      icon: Cpu,
      color: "text-blue-500",
      bg: "bg-blue-50",
    },
    {
      ...
      description:
        "Exclusive innovation lab established in association with INTEL for embedded systems and IoT research.",
      icon: Microscope,
      color: "text-sky-500",
      bg: "bg-sky-50",
    },
    {
      ...
      description:
        "High-end computing systems for advanced image processing, wireless networks, and multimedia analytics.",
      icon: Eye,
    ...
    },
    {
      ...
      description:
        "Dedicated lab under Nokia University India Grant to study and develop latest mobile technologies.",
      icon: Smartphone,
    ...
    },
    {
      ...
      description:
        "Synthesis and characterization of new alloys. Established with 2.62 Crores grant from DRDO.",
      icon: FlaskConical,
    ...
    },
    {
      ...
      description:
        "Pioneering research into advanced composite materials and smart structures for aerospace applications.",
      icon: Layers,
    ...
    },
    {
      ...
      description:
        "State-of-the-art soil mechanics and geotechnical investigations for complex infrastructure projects.",
      icon: Mountain,
    ...
    },
    {
      ...
      description:
        "Advanced testing facilities and analysis tools for structural integrity and earthquake engineering.",
      icon: Building2,
    ...
    },
    {
      ...
      description:
        "Geospatial technology application for environmental monitoring, resource management, and mapping.",
      icon: Satellite,
      color: "text-cyan-500",
      bg: "bg-cyan-50",
    },
    {
      ...
      description:
        "Industrial automation technology hub involving hydraulic and pneumatic drives for aerospace.",
      icon: Cog,
      color: "text-red-500",
      bg: "bg-red-50",
    },
    {
      ...
      description:
        "Modeling and Simulation of Wind Energy Conversion Systems and Solar-Wind Hybrid implementations.",
      icon: Wind,
    ...
    },
    {
      ...
      description:
        "Supervisory Control and Data Acquisition systems for smart grid distribution and automation.",
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Research, Information and Demonstration Centre focused on sustainable bioenergy solutions.",
      icon: Leaf,
      color: "text-lime-500",
      bg: "bg-lime-50",
    },
    ...
    <div className="space-y-12">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-slate-900 p-8 md:p-12 text-white shadow-2xl">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight bg-clip-text text-transparent bg-linear-to-r from-white via-indigo-200 to-indigo-400">
            Centres of Excellence
          </h1>
          <p className="text-slate-400 text-lg leading-relaxed">
            State-of-the-art research hubs driving innovation through industry
          ...
          return (
            ...
            >
              <div className="group h-full relative bg-white rounded-2xl border border-slate-100 hover:border-indigo-100 shadow-sm hover:shadow-xl hover:shadow-indigo-500/10 transition-all duration-300 overflow-hidden flex flex-col">
                {/* Gradient BG Hover */}
                <div className="absolute inset-0 bg-linear-to-br from-white to-slate-50 opacity-100 group-hover:opacity-0 transition-opacity" />
                <div className="absolute inset-0 bg-linear-to-br from-indigo-50/50 to-white opacity-0 group-hover:opacity-100 transition-opacity" />
