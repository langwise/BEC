      ...
      <div className="space-y-12">
        ...
        >
          <Card className="border-orange-100 shadow-lg overflow-hidden">
            <div className="bg-linear-to-r from-orange-50 to-white px-8 py-6 border-b border-orange-100 flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-orange-100 text-orange-600 flex items-center justify-center font-bold text-xl shadow-sm">
                1
              </div>
            ...
            <CardContent className="p-8">
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-start p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-orange-200 transition-colors"
                  >
        ...
        >
          <Card className="border-slate-100 shadow-lg overflow-hidden">
            <div className="bg-linear-to-r from-amber-50 to-white px-8 py-6 border-b border-amber-100 flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-amber-100 text-amber-600 flex items-center justify-center font-bold text-xl shadow-sm">
                2
              </div>
            ...
            <CardContent className="p-8">
              <ul className="grid gap-4">
                {[
                  ...
                  <li
                    key={index}
                    className="flex items-start text-slate-700 group md:items-center p-2 hover:bg-slate-50 rounded-lg transition-colors"
                  >
            ...
            <CardContent className="p-8 space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <ul className="space-y-4 text-sm text-slate-600">
                    <li className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-amber-50 text-amber-600 flex items-center justify-center text-xs font-bold shrink-0">
                        1
                      </div>
                      <span className="leading-relaxed">
                        Present at least 15 days/semester in research centre,
                        before review.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      ...
                      <span className="leading-relaxed">
                        Sign attendance & biometric during visits.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-amber-50 text-amber-600 flex items-center justify-center text-xs font-bold shrink-0">
                      ...
                      <span className="leading-relaxed">
                        Provide Employer NOC & willingness for 1 month
                        leave/year.
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <ul className="space-y-4 text-sm text-slate-600">
                    <li className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-orange-50 text-orange-600 flex items-center justify-center text-xs font-bold shrink-0">
                        1
                      </div>
                      <span className="leading-relaxed">
                        Daily attendance & biometric on all working days.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-orange-50 text-orange-600 flex items-center justify-center text-xs font-bold shrink-0">
                      ...
                      <span className="leading-relaxed">
                        Provide NOC & 3 years study leave if employed. No other
                        jobs allowed.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      ...
                      <span className="leading-relaxed">
                        Unemployed can apply for scholarships with intimation.
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-slate-600 text-sm">
                  <li className="flex gap-2">
                    ...
                    4 external experts (one IIT/NIT) list submitted to
                    Principal.
                  </li>
                  <li className="flex gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-1.5 shrink-0" />
                    Principal approves experts.
                  </li>
                  <li className="flex gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-1.5 shrink-0" />
                    Significant faculty/student presence (25% / 50%) required.
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p className="text-slate-500 text-sm mb-3 font-medium">
                  Scholar must apply 3 days in advance with:
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-slate-900 text-white border-none shadow-xl">
              <CardContent className="p-8 flex flex-col items-center text-center">
                ...
                <p className="text-slate-300 text-sm leading-relaxed mb-6">
                  Scholar informs readiness. Guide invites experts. Report
                  focuses on work completed and recommendations.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-orange-600 text-white border-none shadow-xl">
              <CardContent className="p-8 flex flex-col items-center text-center">
                ...
                <h4 className="text-xl font-bold mb-4">
                  Open Seminars & Colloquium
                </h4>
                <p className="text-orange-50 text-sm leading-relaxed mb-6">
                  Pre-submission colloquium presenting complete work. Committee
                  approval required for final thesis submission.
                </p>
              </CardContent>
            </Card>
          </div>
