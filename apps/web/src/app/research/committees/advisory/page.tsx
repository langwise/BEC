  ...
  return (
    <div className="space-y-12">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-orange-600 to-amber-600 p-10 text-white shadow-xl">
        ...
        >
          ...
          <p className="text-orange-50 max-w-2xl mx-auto text-lg">
            Guiding the strategic direction and upholding the highest standards
            of research excellence at BEC.
          </p>
        </motion.div>
      </div>
      ...
      <section className="bg-white rounded-3xl p-8 md:p-12 border border-slate-200 shadow-sm relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-linear-to-b from-orange-50 to-transparent rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 opacity-60" />
          ...
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-6">
            {rolesAndResponsibilities.map((role, index) => (
              ...
              >
                ...
                <p className="text-slate-600 leading-relaxed text-sm">{role}</p>
              </motion.div>
            ))}
          </div>
        </div>
