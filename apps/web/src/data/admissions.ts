...
export const MANAGEMENT_QUOTA_CONTACT = {
  centralOffice: {
    ...
    phones: ["88844 52964", "88844 52965"],
  },
  admissionSection: {
...
export const admissionProgrammes: AdmissionProgramme[] = [
  {
    ...
    duration: "4 Years",
    seats: "960 sanctioned seats",
    description:
      "Four-year B.E. programmes across 10 disciplines, admitted through Karnataka CET, COMED-K, JEE or the institute entrance for management seats.",
    intro:
      "Basaveshwar Engineering College, Bagalkote is an autonomous institute offering B.E. programmes in 10 disciplines with a total sanctioned intake of 960 seats. Admissions are conducted through Karnataka CET (KEA), COMED-K, JEE, or the entrance examination conducted by the college for management-quota seats.",
    eligibility: [
    ...
    intakeTables: [
      {
        ...
        rows: [
          ...
          { branch: "Computer Science & Engineering", intake: 30 },
          ...
          { branch: "Mechanical Engineering", intake: 90 },
        ],
        total: 300,
      },
      {
