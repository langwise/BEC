        ...
        <div className="container w-full mx-auto px-4 md:px-6 text-center">
          ...
          <div className="mx-auto my-0 max-w-full flex flex-wrap justify-center w-full md:w-10/12 lg:w-3/4">
            <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed">
              Established in 1963, Basaveshwar Engineering College stands as a beacon of excellence in technical education. With over six decades of academic excellence, we nurture innovation, foster research, and shape future leaders who make a difference in the world.
            </p>
          </div>
        </div>
      </div>
