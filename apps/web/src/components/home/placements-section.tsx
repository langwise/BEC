          ...
          <div className="space-y-10">
            <FadeIn>
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 mb-6 leading-[1.1]">
                Launch your career with <span className="text-primary">industry leaders</span>
              </h2>
              
              <p className="text-lg text-gray-600 leading-relaxed font-medium max-w-xl">
                Our rigorous training and strong recruiter network ensure you step confidently into roles across technology, consulting, and core engineering.
              </p>
            </FadeIn>

            <FadeIn delay={0.2} className="flex flex-wrap gap-4">
               <Button className="h-12 px-8 rounded-full text-base font-bold shadow-lg shadow-orange-200 hover:shadow-xl hover:-translate-y-0.5 transition-all">
                  Placement Report
               </Button>
               <Button variant="outline" className="h-12 px-8 rounded-full text-base font-bold border-gray-200 hover:bg-gray-50 hover:text-primary">
                  Our Recruiters
               </Button>
            </FadeIn>
          ...
          <FadeIn delay={0.4} direction="left">
             <div className="relative bg-white rounded-3xl p-8 lg:p-12 shadow-xl shadow-gray-100 border border-gray-100">
                <div className="flex items-center justify-between mb-8">
                    <h3 className="text-xl font-bold text-gray-900">Top Recruiters</h3>
                    <a href="#" className="text-sm font-bold text-primary flex items-center gap-1 hover:gap-2 transition-all">View All <ArrowRight className="w-4 h-4"/></a>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-12">
                   {topRecruiters.map((company, index) => (
                      <div key={index} className="aspect-video relative grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300 flex items-center justify-center">
                          <Image
                             src={company.logo}
                             alt={company.name}
                             fill
                ...
                <div className="mt-10 pt-8 border-t border-gray-50 text-center">
                    <p className="text-sm text-gray-500 font-medium">
                        Join <span className="text-gray-900 font-bold">3000+</span> alumni working at Fortune 500 companies
                    </p>
                </div>
             </div>
          </FadeIn>
