...
const upcomingEvents = [
  {
    ...
    description: "Join us for a day of innovation showcasing cutting-edge research and industry insights from leading experts.",
    date: {
      month: "JAN",
      day: "15",
      year: "2025",
  ...
  },
  {
    ...
    description: "Hands-on workshop exploring practical ML applications in engineering.",
    date: {
      month: "JAN",
      day: "20",
      year: "2025",
  ...
  },
  {
    ...
    description: "Distinguished speaker series featuring industry leaders discussing renewable energy solutions.",
    date: {
      month: "JAN",
      day: "25",
      year: "2025",
  ...
  {
    id: 4,
    title: "Industry Connect: Career Fair 2025",
    description: "Connect with top recruiters and explore exciting career opportunities.",
    date: {
      month: "FEB",
      day: "05",
      year: "2025",
