...
export default function EeeMentorshipProgram() {
  ...
  const milestones = [
    { src: asset("departments/eee/mentorship/poster-1.png"), title: "Milestone Poster 1" },
    { src: asset("departments/eee/mentorship/poster-2.png"), title: "Milestone Poster 2" },
    { src: asset("departments/eee/mentorship/poster-3.png"), title: "Milestone Poster 3" },
    { src: asset("departments/eee/mentorship/poster-4.png"), title: "Milestone Poster 4" },
    { src: asset("departments/eee/mentorship/poster-5.png"), title: "Milestone Poster 5" },
    { src: asset("departments/eee/mentorship/poster-6.png"), title: "Milestone Poster 6" },
    { src: asset("departments/eee/mentorship/poster-7.png"), title: "Milestone Poster 7" },
    { src: asset("departments/eee/mentorship/poster-8.png"), title: "Milestone Poster 8" }
  ];

  const mentorLists = [
    asset("departments/eee/mentorship/mentor-1.png"),
    asset("departments/eee/mentorship/mentor-2.png"),
    asset("departments/eee/mentorship/mentor-3.png")
  ];
